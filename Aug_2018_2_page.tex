...
\section{Leadership}
    ...
    \resumeSubheading
      {Computer Science Graduate Student Association (CSEGSA)}{Texas A\&M University}
      {Treasurer}{August 2018 -- Present}
      \resumeSubHeadingListStart
        \resumeItem{}
          {Responsible for overseeing and presenting budgets, accounts and financial statements of the association}
        \resumeSubHeadingListEnd
